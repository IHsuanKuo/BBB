table 50120 Reward
{
    ...
    fields
    {
        ...
        field(3; "Discount Percentage"; Decimal)
        {
            ...
            //The "Maxvalue" property sets the minimum value for the "Discount Percentage"
            //field.
            MaxValue = 100;

            //The "DecimalPlaces" property is set to 2 to display discount values
            //exactly 2 decimals.
            DecimalPlaces = 2;
        }
    ...
    keys
    {
        //The field "Reward ID" is used as the primary key of this
        key(PK; "Reward ID")
        {
